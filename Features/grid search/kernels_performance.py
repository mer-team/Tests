...
best_kernels_csv.to_csv('./best_kernels_csv_per_feature.csv', index = False, columns=headers, mode='w')

path = "./results_gridsearch_accompanimentaudio_20210813/"
for file in listdir(path):
    ...
    for kernel in kernel_list:
        ...
        best_kernel.to_csv('./best_kernels_csv_per_feature.csv', header=False, index = False, mode='a')

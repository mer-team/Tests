...
# SETUP
dataset_path = './datasets/accompaniment_after_correlation.csv'
ranking_path  = './results/feature_ranking/chi2/audio/accompaniment_20210813/chi2_features_weight_sorted.csv'

# import dataset
csvFile = pd.read_csv(dataset_path, sep = ";", index_col=False)
...
feat_ranking = pd.read_csv(ranking_path, sep = ",", index_col=False)

# standardize feature_rankings (chi2 ranking columns are capitalized
feat_ranking.rename(columns={"Features":"feature"}, inplace=True)

# number of features to use
features_grid = [10, 25, 50, *range(100, len(headers)+1, 100), len(headers)] # 200, 300, 400, 500, 600, 700, 800, 900]

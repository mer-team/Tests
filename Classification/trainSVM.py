...
gamma = 'scale'
degree = 4
classifier_name = 'lyrics_model.joblib'
scaler_name = 'lyrics_scaler.joblib'
figure_title = 'Confusion Matrix for dataset Audio - Lyrics'
figure_name = 'lyrics_confusion_matrix.png'
...
# classifier
clf = svm.SVC(random_state = 0, kernel=kernel, C=cost, gamma=gamma, degree= degree)

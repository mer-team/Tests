...
def callback(ch, method, properties, body):
    ...
    if "song" not in info or "artist" not in info:

        msg = {
            "Service": "GenreFinder",
            "Result": { "videoID": info['vID'], "Error" : "True", "Result": "Cannot get Genre" }
        }
        ...
        if "error" in req:
            msg = {
                "Service": "GenreFinder",
                "Result": { "videoID": info['vID'], "Error" : "True", "Result": req['message'] }
            }
            ...
            msg = {
                "Service": "GenreFinder",
                "Result": { "videoID": info['vID'], "Error" : "False", "Result": genres }
            }
            channel.basic_publish(exchange='',
                            routing_key='management',
                            body=json.dumps(msg))
